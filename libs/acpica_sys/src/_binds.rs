...
pub const PCI_ROOT_HID_STRING: &'static [u8; 8usize] = b"PNP0A03\0";
pub const PCI_EXPRESS_ROOT_HID_STRING: &'static [u8; 8usize] = b"PNP0A08\0";
...
pub const METHOD_NAME__ADR: &'static [u8; 5usize] = b"_ADR\0";
pub const METHOD_NAME__AEI: &'static [u8; 5usize] = b"_AEI\0";
pub const METHOD_NAME__BBN: &'static [u8; 5usize] = b"_BBN\0";
pub const METHOD_NAME__CBA: &'static [u8; 5usize] = b"_CBA\0";
pub const METHOD_NAME__CID: &'static [u8; 5usize] = b"_CID\0";
pub const METHOD_NAME__CLS: &'static [u8; 5usize] = b"_CLS\0";
pub const METHOD_NAME__CRS: &'static [u8; 5usize] = b"_CRS\0";
pub const METHOD_NAME__DDN: &'static [u8; 5usize] = b"_DDN\0";
pub const METHOD_NAME__DMA: &'static [u8; 5usize] = b"_DMA\0";
pub const METHOD_NAME__HID: &'static [u8; 5usize] = b"_HID\0";
pub const METHOD_NAME__INI: &'static [u8; 5usize] = b"_INI\0";
pub const METHOD_NAME__PLD: &'static [u8; 5usize] = b"_PLD\0";
pub const METHOD_NAME__DSD: &'static [u8; 5usize] = b"_DSD\0";
pub const METHOD_NAME__PRS: &'static [u8; 5usize] = b"_PRS\0";
pub const METHOD_NAME__PRT: &'static [u8; 5usize] = b"_PRT\0";
pub const METHOD_NAME__PRW: &'static [u8; 5usize] = b"_PRW\0";
pub const METHOD_NAME__PS0: &'static [u8; 5usize] = b"_PS0\0";
pub const METHOD_NAME__PS1: &'static [u8; 5usize] = b"_PS1\0";
pub const METHOD_NAME__PS2: &'static [u8; 5usize] = b"_PS2\0";
pub const METHOD_NAME__PS3: &'static [u8; 5usize] = b"_PS3\0";
pub const METHOD_NAME__REG: &'static [u8; 5usize] = b"_REG\0";
pub const METHOD_NAME__SB_: &'static [u8; 5usize] = b"_SB_\0";
pub const METHOD_NAME__SEG: &'static [u8; 5usize] = b"_SEG\0";
pub const METHOD_NAME__SRS: &'static [u8; 5usize] = b"_SRS\0";
pub const METHOD_NAME__STA: &'static [u8; 5usize] = b"_STA\0";
pub const METHOD_NAME__SUB: &'static [u8; 5usize] = b"_SUB\0";
pub const METHOD_NAME__UID: &'static [u8; 5usize] = b"_UID\0";
pub const METHOD_PATHNAME__PTS: &'static [u8; 6usize] = b"\\_PTS\0";
pub const METHOD_PATHNAME__SST: &'static [u8; 10usize] = b"\\_SI._SST\0";
pub const METHOD_PATHNAME__WAK: &'static [u8; 6usize] = b"\\_WAK\0";
...
pub const ACPI_CA_VERSION: u32 = 539033861;
...
pub type ACPI_STRING = *mut ::cty::c_char;
pub type ACPI_HANDLE = *mut ::cty::c_void;
...
pub type ACPI_OSD_HANDLER =
    ::core::option::Option<unsafe extern "C" fn(Context: *mut ::cty::c_void) -> UINT32>;
pub type ACPI_OSD_EXEC_CALLBACK =
    ::core::option::Option<unsafe extern "C" fn(Context: *mut ::cty::c_void)>;
...
pub type ACPI_NOTIFY_HANDLER = ::core::option::Option<
    unsafe extern "C" fn(Device: ACPI_HANDLE, Value: UINT32, Context: *mut ::cty::c_void),
>;
pub type ACPI_OBJECT_HANDLER =
    ::core::option::Option<unsafe extern "C" fn(Object: ACPI_HANDLE, Data: *mut ::cty::c_void)>;
...
pub type ACPI_ADR_SPACE_HANDLER = ::core::option::Option<
    unsafe extern "C" fn(
        ...
        BitWidth: UINT32,
        Value: *mut UINT64,
        HandlerContext: *mut ::cty::c_void,
        RegionContext: *mut ::cty::c_void,
    ) -> ACPI_STATUS,
>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub type ACPI_ADR_SPACE_SETUP = ::core::option::Option<
    unsafe extern "C" fn(
        ...
        Function: UINT32,
        HandlerContext: *mut ::cty::c_void,
        RegionContext: *mut *mut ::cty::c_void,
    ) -> ACPI_STATUS,
>;
pub type ACPI_WALK_CALLBACK = ::core::option::Option<
    unsafe extern "C" fn(
        ...
        NestingLevel: UINT32,
        Context: *mut ::cty::c_void,
        ReturnValue: *mut *mut ::cty::c_void,
    ) -> ACPI_STATUS,
>;
...
pub struct acpi_memory_list {
    pub ListName: *const ::cty::c_char,
    pub ListHead: *mut ::cty::c_void,
...
pub type ACPI_TRACE_EVENT_TYPE = ::cty::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub struct acpi_table_header {
    ...
    pub AslCompilerId: [::cty::c_char; 4usize],
...
pub struct acpi_table_rsdp {
    pub Signature: [::cty::c_char; 8usize],
    pub Checksum: UINT8,
    pub OemId: [::cty::c_char; 6usize],
    pub Revision: UINT8,
...
pub type AcpiPreferredPmProfiles = ::cty::c_uint;
#[repr(C)]
#[derive(Copy, Clone)]
pub union acpi_name_union {
    pub Integer: UINT32,
    pub Ascii: [::cty::c_char; 4usize],
...
pub type AcpiAsfType = ::cty::c_uint;
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
pub type AcpiBertErrorSeverity = ::cty::c_uint;
...
pub const AcpiDmarType_ACPI_DMAR_TYPE_RESERVED: AcpiDmarType = 5;
pub type AcpiDmarType = ::cty::c_uint;
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
pub type AcpiDmarScopeType = ::cty::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub struct acpi_dmar_andd {
    ...
    pub DeviceName: [::cty::c_char; 1usize],
}
...
pub const AcpiEinjActions_ACPI_EINJ_ACTION_RESERVED: AcpiEinjActions = 10;
pub const AcpiEinjActions_ACPI_EINJ_TRIGGER_ERROR: AcpiEinjActions = 255;
pub type AcpiEinjActions = ::cty::c_uint;
...
pub type AcpiEinjInstructions = ::cty::c_uint;
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
pub type AcpiEinjCommandStatus = ::cty::c_uint;
...
pub type AcpiErstActions = ::cty::c_uint;
...
pub type AcpiErstInstructions = ::cty::c_uint;
...
pub type AcpiErstCommandStatus = ::cty::c_uint;
#[repr(C, packed)]
#[derive(Copy, Clone)]
...
pub type AcpiFpdtType = ::cty::c_uint;
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
pub type AcpiS3ptType = ::cty::c_uint;
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
pub type AcpiGtdtType = ::cty::c_uint;
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
pub type AcpiHestTypes = ::cty::c_uint;
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
pub type AcpiHestNotifyTypes = ::cty::c_uint;
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
pub type AcpiHmatType = ::cty::c_uint;
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
pub type AcpiHpetPageProtect = ::cty::c_uint;
...
pub type AcpiIbftType = ::cty::c_uint;
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
pub struct acpi_iort_node {
    ...
    pub NodeData: [::cty::c_char; 1usize],
}
...
pub type AcpiIortNodeType = ::cty::c_uint;
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
pub type AcpiIvrsType = ::cty::c_uint;
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
pub type AcpiIvrsDeviceEntryType = ::cty::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub type AcpiLpitType = ::cty::c_uint;
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
pub const AcpiMadtType_ACPI_MADT_TYPE_RESERVED: AcpiMadtType = 16;
pub type AcpiMadtType = ::cty::c_uint;
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
pub struct acpi_madt_local_sapic {
    ...
    pub LapicFlags: UINT32,
    pub Uid: UINT32,
    pub UidString: [::cty::c_char; 1usize],
}
...
pub type AcpiMadtGicVersion = ::cty::c_uint;
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
pub type AcpiNfitType = ::cty::c_uint;
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
pub const AcpiPcctType_ACPI_PCCT_TYPE_RESERVED: AcpiPcctType = 5;
pub type AcpiPcctType = ::cty::c_uint;
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
pub type ACPI_PMTT_DOMAIN = acpi_pmtt_domain;
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
pub type AcpiPpttType = ::cty::c_uint;
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
pub type AcpiRasfCommands = ::cty::c_uint;
...
pub type AcpiRasfCapabiliities = ::cty::c_uint;
...
pub const AcpiRasfPatrolScrubCommands_ACPI_RASF_STOP_PATROL_SCRUBBER: AcpiRasfPatrolScrubCommands =
    3;
pub type AcpiRasfPatrolScrubCommands = ::cty::c_uint;
...
pub type AcpiRasfStatus = ::cty::c_uint;
...
pub type AcpiSdevType = ::cty::c_uint;
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
pub type AcpiSpmiInterfaceTypes = ::cty::c_uint;
...
pub const AcpiSratType_ACPI_SRAT_TYPE_RESERVED: AcpiSratType = 6;
pub type AcpiSratType = ::cty::c_uint;
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
...
pub type AcpiWdatActions = ::cty::c_uint;
...
pub type AcpiWdatInstructions = ::cty::c_uint;
...
pub type ACPI_EXECUTE_TYPE = ::cty::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
extern "C" {
    pub fn AcpiOsCreateLock(OutHandle: *mut *mut ::cty::c_void) -> ACPI_STATUS;
}
extern "C" {
    pub fn AcpiOsDeleteLock(Handle: *mut ::cty::c_void);
}
extern "C" {
    pub fn AcpiOsAcquireLock(Handle: *mut ::cty::c_void) -> ACPI_SIZE;
}
extern "C" {
    pub fn AcpiOsReleaseLock(Handle: *mut ::cty::c_void, Flags: ACPI_SIZE);
}
extern "C" {
...
extern "C" {
    pub fn AcpiOsDeleteSemaphore(Handle: *mut ::cty::c_void) -> ACPI_STATUS;
}
extern "C" {
...
extern "C" {
    pub fn AcpiOsSignalSemaphore(Handle: *mut ::cty::c_void, Units: UINT32) -> ACPI_STATUS;
}
extern "C" {
    pub fn AcpiOsAllocate(Size: ACPI_SIZE) -> *mut ::cty::c_void;
}
extern "C" {
    pub fn AcpiOsAllocateZeroed(Size: ACPI_SIZE) -> *mut ::cty::c_void;
}
extern "C" {
    pub fn AcpiOsFree(Memory: *mut ::cty::c_void);
}
extern "C" {
    pub fn AcpiOsMapMemory(Where: ACPI_PHYSICAL_ADDRESS, Length: ACPI_SIZE) -> *mut ::cty::c_void;
}
extern "C" {
    pub fn AcpiOsUnmapMemory(LogicalAddress: *mut ::cty::c_void, Size: ACPI_SIZE);
}
extern "C" {
...
extern "C" {
    pub fn AcpiOsDeleteCache(Cache: *mut ACPI_MEMORY_LIST) -> ACPI_STATUS;
}
extern "C" {
    pub fn AcpiOsPurgeCache(Cache: *mut ACPI_MEMORY_LIST) -> ACPI_STATUS;
}
extern "C" {
    pub fn AcpiOsAcquireObject(Cache: *mut ACPI_MEMORY_LIST) -> *mut ::cty::c_void;
}
extern "C" {
...
extern "C" {
    pub fn AcpiOsReadable(Pointer: *mut ::cty::c_void, Length: ACPI_SIZE) -> BOOLEAN;
}
extern "C" {
    pub fn AcpiOsWritable(Pointer: *mut ::cty::c_void, Length: ACPI_SIZE) -> BOOLEAN;
}
extern "C" {
    pub fn AcpiOsGetTimer() -> UINT64;
}
extern "C" {
    pub fn AcpiOsSignal(Function: UINT32, Info: *mut ::cty::c_void) -> ACPI_STATUS;
}
extern "C" {
...
extern "C" {
    pub fn AcpiOsPrintf(Format: *const ::cty::c_char, ...);
}
extern "C" {
    pub fn AcpiOsVprintf(Format: *const ::cty::c_char, Args: *mut __va_list_tag);
}
extern "C" {
    pub fn AcpiOsRedirectOutput(Destination: *mut ::cty::c_void);
}
extern "C" {
...
extern "C" {
    pub fn AcpiOsOpenDirectory(
        Pathname: *mut ::cty::c_char,
        WildcardSpec: *mut ::cty::c_char,
        RequestedFileType: ::cty::c_char,
    ) -> *mut ::cty::c_void;
}
extern "C" {
    pub fn AcpiOsGetNextFilename(DirHandle: *mut ::cty::c_void) -> *mut ::cty::c_char;
}
extern "C" {
    pub fn AcpiOsCloseDirectory(DirHandle: *mut ::cty::c_void);
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
extern "C" {
    pub static mut AcpiGbl_TraceMethodName: *const ::cty::c_char;
}
extern "C" {
...
extern "C" {
    pub fn AcpiFormatException(Exception: ACPI_STATUS) -> *const ::cty::c_char;
}
extern "C" {
...
pub type ACPI_WALK_RESOURCE_CALLBACK = ::core::option::Option<
    unsafe extern "C" fn(Resource: *mut ACPI_RESOURCE, Context: *mut ::cty::c_void) -> ACPI_STATUS,
>;
extern "C" {
...
extern "C" {
    pub fn AcpiInfo(Format: *const ::cty::c_char, ...);
}
extern "C" {
...
extern "C" {
    pub fn AcpiRunDebugger(BatchBuffer: *mut ::cty::c_char);
}
extern "C" {
